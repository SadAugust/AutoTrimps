...
if (game.global.universe == 1) {
	...
	var presetList = [preset_Zek059, preset_Zek229, preset_Zek299, preset_Zek399, preset_Zek449, preset_Zek450, preset_Zek500, preset_Zek550, preset_space];
	var presetListHtml = "\
	...
	AutoPerks.getSomePerks = function (fixed, variable, tier2, allperks) {
		...
		for (var i in AutoPerks.perkHolder) {
			...
			if ((fixed && AutoPerks.perkHolder[i].fixed) ||
				...
				(allperks)) { perks.push(AutoPerks.perkHolder[i]); }
		}
		return perks;
	}
