...
function equalityManagement() {
	...
	if (enemyHealth > 0) {
		for (var i = 0; i <= maxEquality; i++) {
			...
			else if ((ourHealth === 0 && !mapping) || armyReady && (ourHealth < (ourHealthMax * (dailyEmpowerToggle ? 0.95 : 0.65))) && gammaToTrigger === gammaMaxStacksCheck && gammaMaxStacksCheck !== Infinity && !runningTrappa && !runningArchaeology && !runningBerserk) {
