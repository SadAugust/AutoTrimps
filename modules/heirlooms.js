...
function heirloomShieldToEquip(mapType, query) {
	...
	if (game.global.world >= 366 && getPageSetting('gameUser') === 'SadAugust' && game.global.lastClearedCell < 96 && game.global.gridArray[game.global.lastClearedCell + 3].u2Mutation.indexOf('CMP') !== -1) swapZone = 999;
