function MAZLookalike(titleText, varPrefix, event) {
	...
	//AutoStructure
		...
		const safeGateway = "<p><b>Safe Gateway:</b> Will stop purchasing Gateways when your owned fragments are lower than the cost of the amount of maps you input in the 'Maps' field times by what a Perfect +10 LMC map would cost up to the zone specified in 'Till Z:', if that value is 0 it'll assume you want them capped forever.</p>";
