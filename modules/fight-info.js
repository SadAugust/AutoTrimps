(function (M) {
    ...
    M['fightinfo'].exoticImps = ['Chronoimp', 'Feyimp', 'Flutimp', 'Goblimp', 'Jestimp', 'Magnimp', 'Tauntimp', 'Titimp', 'Venimp', 'Whipimp', 'Randimp'];
    ...
    function updateCell($cell, cell, pallet, customIcon, overrideSpecial, overrideCoords) {
        ...
        //Icon Overriding
        if (cell.special.length === 0 || (overrideSpecial && replaceable.includes(cell.special))) $cell.innerHTML = '<span class=' + icon + '></span>';
    }
    ...
    function Update() {
        ...
        if (!game.global.mapsActive && M['fightinfo'].lastProcessedWorld === game.global.world) return;
