...
function initializeAllSettings() {
	...
	if (displayC2) {
		...
		createSetting('c2Finish',
			...
			function () { return ('<b>DONT USE THIS WITH ' + cinf() + ' RUNNER. ITS FINISH ZONE WILL OVERRIDE THIS</b><br>Finish / Abandon Challenge2 (any) when this zone is reached, if you are running one. For manual use. Recommended: Zones ending with 0 for most Challenge2. Disable with -1. Does not affect Non-Challenge2 runs.') },
			'value', -1, null, 'C2', [1, 2]);
		...
		createSetting('pandemoniumMP',
			...
			function () { return ('How many smithies to run Melting Point at during Pandemonium. <b>THIS OVERRIDES UNIQUE MAP SETTINGS INPUTS</b>') },
			'value', '-1', null, 'C2', [2],
			function () { return (getPageSetting('pandemonium', currSettingUniverse)) });
		...
		createSetting('desolationMP',
			...
			function () { return ('How many smithies to run Melting Point at during Desolation. <b>THIS OVERRIDES UNIQUE MAP SETTINGS INPUTS</b>') },
			'value', '-1', null, 'C2', [2],
			function () { return (getPageSetting('desolation', currSettingUniverse)) });
	}
