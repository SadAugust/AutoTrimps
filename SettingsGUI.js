...
function initializeAllSettings() {
	...
	createSetting('RAlchDontBuyMets', 'No mets on 152', 'Will stop purchasing meteorologists on zone 152 to try and obtain an extra one through Atlantrimp which it\'ll run if you have enough food to afford an extra meteorologist from it. If you\'re don\'t believe you\'ll achieve this it\'s best to leave this off as it\'ll have a negative impact on your rn/hr.', 'boolean', false, null, 'Challenges');
