...
function HeirloomEquipShield(heirloom) {
    if (HeirloomSearch(heirloom) != undefined && game.global.ShieldEquipped.name != getPageSetting(heirloom)) {
        ...
        debug("The heirloom named " + autoTrimpSettings[heirloom].value + " in the Shield setting: " + autoTrimpSettings[heirloom].name + " doesn\'t exist. Rename a heirloom or adjust the settings input.");
}
...
function HeirloomEquipStaff(heirloom) {
    if (HeirloomSearch(heirloom) != undefined && game.global.StaffEquipped.name != getPageSetting(heirloom)) {
        ...
        debug("The heirloom named " + autoTrimpSettings[heirloom].value + " in the Staff setting: " + autoTrimpSettings[heirloom].name + " doesn\'t exist. Rename a heirloom or adjust the settings input.");
}
