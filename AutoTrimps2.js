var ATversion='SadAugust v4.4.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://github.io/AutoTrimps_Local/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
