var ATversion = 'SadAugust v4.5.0', atscript = document.getElementById('AutoTrimps-script'), basepath = 'https://SadAugust.github.io/AutoTrimps_Local/', modulepath = 'modules/'; null !== atscript && (basepath = atscript.src.replace(/AutoTrimps2\.js$/, ''));
...
function mainLoop() {
	...
	if (game.global.stringVersion >= '5.8.0' && getPageSetting('automateSpireAssault') && autoBattle.maxEnemyLevel < 100)
